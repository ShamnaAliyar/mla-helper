      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                      <a class="" href="../mla/home.jsp">
                          <i class="icon_house_alt"></i>
                          <span>Home</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                      <a href="../mla/Fundtransfer.jsp" class="">
                          <i class="icon_desktop"></i>
                          <span>Fund Usages</span>
                         
                      </a>
                     
                  </li>
                  <li class="sub-menu">
                      <a href="../mla/events.jsp" class="">
                          <i class="icon_desktop"></i>
                          <span>Events</span>
                  ...
                  <li>
                      <a class="" href="../mla/view appo.jsp">
                          <i class="icon_genius"></i>
                          <span>Appointments</span>
                      </a>
                  </li>
                  <li>                     
                      <a class="" href="../mla/view complaints.jsp">
                          <i class="icon_piechart"></i>
                          <span>Message<label style="color: red"></label></span>

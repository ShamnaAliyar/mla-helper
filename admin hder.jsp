<%-- 
    Document   : admin hder
    Created on : 6 Apr, 2016, 5:42:43 AM
    Author     : Manu Jose
--%>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
                      <a class="" href="../user/userhome2.jsp">
                  ...
                  <li class="sub-menu">
                      <a href="../admin/Mla view.jsp" class="">
                          <i class="icon_desktop"></i>
                          <span>Approve MLA</span>
                 ...
                 <li class="sub-menu">
                     <a href="../admin/user view.jsp" class="">
                          <i class="icon_desktop"></i>
                   ...
                   <li class="sub-menu">
                       <a href="../admin/add constituency.jsp" class="">
